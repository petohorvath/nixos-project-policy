...
- Remove the policy-owned formatting/lint job and `lint` command. Members own formatting and lint enforcement; older selected releases retain their required gates.
